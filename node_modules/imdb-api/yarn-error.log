Arguments: 
  /usr/local/bin/node /usr/local/bin/yarn add -D @type/nodeunit

PATH: 
  /home/worr/bin:/bin:/sbin:/usr/bin:/usr/sbin:/usr/X11R6/bin:/usr/local/bin:/usr/local/sbin:/usr/games
...
Trace: 
  Error: https://registry.yarnpkg.com/@type%2fnodeunit: Not found
...
npm manifest: 
  {
    ...
    "scripts": {
      ...
      "test": "nyc --reporter=lcov node_modules/nodeunit/bin/nodeunit test",
...
Lockfile: 
  ...
  js-yaml@^3.10.0, js-yaml@^3.2.7, js-yaml@^3.3.1, js-yaml@^3.6.1, js-yaml@^3.7.0:
    version "3.11.0"
